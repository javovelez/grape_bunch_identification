...
def main():
    mejoradas_input_dir = '/data/180_mejoradas/thresh0.7/' # 'F:/Escritorio/repo_2023/identificaci-nDeRacimos/src/180_mejoradas/thresh0.7/' #
    a180_input_dir = '/data/180/thresh0.7/' # 'F:/Escritorio/repo_2023/identificaci-nDeRacimos/input/2023.03_captura_2/180/thresh0.7/'
    output_dir = '/data/output/180_mejoradas/thresh0.7/' #  'F:/Escritorio/repo_2023/identificaci-nDeRacimos/output/2023.03_captura_2/180_vs_mejoradas_180/'
    ...
    a180_clouds = {}
    master = open('master_180_old_vs_new.csv')#/data/
