...
def main(args=None):
    ...
    ####
        ...
        threshold_percentage_list = [0.12]   # porcentaje de la distancia en la nube a usar como trheshold
        step = 1/4     # paso de rotación de la nube "source" alrededor del eje z
        save_interval = 100
        start_time = time()
        n_clouds = len(clouds)
        ids = None# ["10", "11", "12", "13", "15", "16", "17", "18", "19", "20", "22", "26", "29", "70", "72", "73", "75", "76", "77", "79", "80", "82", "83", "84", "86"]
